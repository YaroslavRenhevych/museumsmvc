...
@WebAppConfiguration
public class CreatePictureStepDefs {
	@Autowired
	...
	@When("^the client sends data about picture to \"(.*?)\"$")
	...
	@Then("^the client gets status code of (\\d+) means that picture was created$")
	...
	@And("^the client redirected to url \"(.*?)\" for creating new picture$")
